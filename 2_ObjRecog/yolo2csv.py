...
def xml_to_csv_from_list(images_list_file_name):
    ...
    with open(images_list_file_name) as f:
      for line in f:
        ...
        xml_file = imageFile.replace('jpg', 'txt')
...
def main():
  ...
  source_file_list = "/media/marda/TWOTB/USGS/SOFTWARE/DL-CDI2020/2_ObjRecog/test_files.txt"
  #dest_csv_file = 'C:\\Yolo\\DataSets\\3classes\\CSV_list_File\\ir_train.csv'  # CHANGE PATH TO YOUR FILE
  dest_csv_file = '/media/marda/TWOTB/USGS/SOFTWARE/DL-CDI2020/2_ObjRecog/test_files.csv'
