...
IMG_PATH = "/media/marda/TWOTB/USGS/SOFTWARE/DL-CDI2020/2_ObjRecog/validation"
fw = os.listdir(IMG_PATH)
# path of save xml file
save_path = '' # keep it blank

# txt_folder is txt file root that using darknet rectbox
txt_folder = "/media/marda/TWOTB/USGS/SOFTWARE/DL-CDI2020/2_ObjRecog/validation_labels"
